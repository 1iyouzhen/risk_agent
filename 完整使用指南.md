...
**错误：** `Neo4j不可用`、python app.py --demo模式报错
<img width="1823" height="234" alt="6a9f39aa5485597834ce76a4453157be" src="https://github.com/user-attachments/assets/eaa0943b-5633-4d18-8f7d-7f41bddeb76b" />
**解决：**
1. 确保Neo4j服务已启动（在电脑本地安装并注册了neo4j以后到cmd中输入neo4j.bat console）
2. 检查连接配置
3. 系统会自动降级，不影响其他功能
